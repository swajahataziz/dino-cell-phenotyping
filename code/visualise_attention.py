...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_weights', default='/fsx/data/checkpoint.pth', type=str,
    ...
    parser.add_argument('--norm_per_channel_file', default="/fsx/data/output/Dino_training_full_0/mean_and_std_of_dataset.txt", help="""path to file with mean and std per channel in json format.""")
    ...
    parser.add_argument("--name_of_run", default="viz_attention", type=str, help="Name of job")
...
classes = list(dataset_total.class_to_idx.keys())
...
if args.scDINO_full_pipeline:
    ...
    print(f'Name of run: {args.name_of_run}')
...
# for class_name, class_number in classes_dict.items():
    ...
    class_idx = list(dataset_total.class_to_idx.values())[list(dataset_total.class_to_idx.keys()).index(class_name)]
    class_indices = [i for i in range(len(dataset_total)) if dataset_total[i][1] == class_idx]
    ...
    for cell in random_indices:
        ...
        try:
            os.makedirs(random_cell_dir, 0o777, True)
            #os.mkdir()
        ...
        for channel in selected_channels:
            ...
            image = image[:,:,multiplied_channels]
