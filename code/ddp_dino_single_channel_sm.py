...
def train_dino(args):
    ...
    norm_per_channel_file = os.path.join(local_root, "output/Dino_training_full_0/mean_and_std_of_dataset.txt")

    selected_channels = list(map(int, args.selected_channels))
    mean_for_selected_channel, std_for_selected_channel = create_mean_std_per_channel_for_channel_combi(norm_per_channel_file, selected_channels)
